...
![Tìm kiếm dịch vụ S3](/4-workshop/4.6-cleanup/image.png)

- Chọn bucket của Frontend (ví dụ: `fpt-event-bucket`).

![Chọn fpt-event-bucket](/4-workshop/4.6-cleanup/image-1.png)

- Tích chọn bucket (hoặc các object bên trong) và nhấn nút **Delete**.

![Chọn Delete](/4-workshop/4.6-cleanup/image-2.png)

- Gõ cụm từ **permanently delete** (xóa vĩnh viễn) vào ô xác nhận hệ thống và thực hiện xóa.

![Chấp nhận permanently delete](/4-workshop/4.6-cleanup/image-3.png)
