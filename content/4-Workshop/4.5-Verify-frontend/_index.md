...
1. **Verify Amazon API Gateway:**
   ...
   ![Select the fpt-event-api](/4-workshop/4.5-verify-frontend/image-1.png)
   
   - Verify that all necessary routes have been linked properly.
   
   ![Verify API routes](/4-workshop/4.5-verify-frontend/image-2.png)
...
2. **Verify Amazon S3 & CloudFront:**
   ...
   ![Get the CloudFront URL](/4-workshop/4.5-verify-frontend/image-8.png)
   
   - The ReactJS interface should load successfully if the deployment was successful.
   
   ![ReactJS Interface success](/4-workshop/4.5-verify-frontend/image-3.png)
...
3. **Verify AWS WAF (Web Application Firewall):**
   ...
   ![WAF page](/4-workshop/4.5-verify-frontend/image-4.png)
   
   ![Confirm WAF Configuration](/4-workshop/4.5-verify-frontend/image-5.png)
